...
class IndexController extends Zend_Controller_Action
{
 ...
 $this->getHelper('layout')->disableLayout();
	...
	switch($type){
		case'kodebrg': $field = "kode_barang"; break;
		case'namabrg': $field = "nama_barang"; break;
		case'qty': $field = "quantity"; break;
		case'harga': $field = "harga_barang"; break;
		case'kodegd': $field = "kode_gudang"; break;
		case'tglout': $field = "tanggal_keluar"; break;
                case'satuan' : $field = "satuan"; break;
	}
